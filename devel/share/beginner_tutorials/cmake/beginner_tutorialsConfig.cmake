...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/connor/rbe3002final/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/connor/rbe3002final/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/connor/rbe3002final/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'connor <connor@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/connor/rbe3002final/src/beginner_tutorials/${idir}'.  Ask the maintainer 'connor <connor@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/connor/rbe3002final/devel/lib;/home/connor/rbe3002final/devel/lib;/opt/ros/indigo/lib)
